...
// s3_utils::MinioClient::MinioClient(const std::string &endpoint, const std::string &accessKey, const std::string &secretKey) {
//     initAwsAPI();
...
// bool s3_utils::MinioClient::upload(const cv::Mat &img, const std::string &bucketName, const std::string &objectKey, const std::vector<int> &vecCompression_params) {
...
// bool s3_utils::MinioClient::upload(const std::string &contents, const std::string &bucketName, const std::string &objectKey) {
//     Aws::S3::Model::PutObjectRequest putObjectRequest;
//     putObjectRequest.WithBucket(bucketName).WithKey(objectKey);
...
//     clientConfig.endpointOverride = "172.24.32.81:34613";
//     // clientConfig.proxyHost = "localhost";
//     // clientConfig.proxyPort = 1234;
//     clientConfig.verifySSL = false;
//     // clientConfig.enableTcpKeepAlive = true;
//     auto m_client = new Aws::S3::S3Client(Aws::Auth::AWSCredentials("test", "12345678"), clientConfig, false, false);
//     // Aws::S3::S3Client(Aws::Auth::AWSCredentials("admin", "admin123456"), clientConfig, false, false);
// }
